...
interface UseTeamsSearchProps<T extends {search : string, page: number}>{
    params : T;
 ...
 * @param params Current Teams params containing `search` and `page`.
 ...
 * <TeamsSearch value={searchValue} onChange={onSearchChange} />
 * ```
 */
export function useTeamsSearch<T extends {
    search : string;
    page : number;
}> ({
    params,
