...
interface UseProjectTaskSearchProps<T extends {search : string, page: number}>{
    params : T;
 ...
 * @param params Current ProjectTask params containing `search` and `page`.
 ...
 * <ProjectTaskSearch value={searchValue} onChange={onSearchChange} />
 * ```
 */
export function useProjectTaskSearch<T extends {
    search : string;
    page : number;
}> ({
    params,
