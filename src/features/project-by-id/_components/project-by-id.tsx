...
import { TaskImageImportDialog } from "./task-image-import-dialog";
...
const TaskDetail = () => {
  ...
  const startDateLabel = formatOptionalDate(
    initialState.startDate,
    "No start date",
  );
  const dueDateLabel = formatOptionalDate(initialState.dueDate, "No due date");
  const endDateLabel = formatOptionalDate(initialState.endDate, "No end date");
      ...
      <DialogContent>
        ...
        <div className="flex items-center gap-x-1.5">
          ...
          <span className={cn("truncate text-xs")}>
            Start: {startDateLabel} | Due: {dueDateLabel} | End: {endDateLabel}
          </span>
        </div>
        <div className="flex items-center gap-x-1.5">
          <ProjectAvatar name={projectName} fallbackClassName="text-[10px]" />
...
export const ProjectIdView = () => {
  ...
  return (
    <>
      <main className=" p-6 flex flex-col gap-6 ">
        ...
        <section className=" flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" onClick={() => setOpenImageImport(true)}>
              <ImageUpIcon className=" size-5" /> Import from image
            </Button>
      ...
      <TaskDetail />
      {/* end to task details */}
      <TaskImageImportDialog
        open={openImageImport}
        onOpenChange={setOpenImageImport}
